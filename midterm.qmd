...
table11.5b %<>% mutate(data_type = "Treatment_for_Severe_Major_Depressive Episode")

tables_to_check_hw <- list(table11.5a, table11.5b)
...
#TODO: Finish the Plotting for this
```
